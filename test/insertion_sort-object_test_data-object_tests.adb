...
--  placed into Insertion_Sort.Object_Test_Data.
...
--  begin read only
--  end read only
package body Insertion_Sort.Object_Test_Data.Object_Tests is
...
--
--  end read only
  Algorithm : Insertion_Sort.Object;
--  begin read only
--  end read only
...
--  id:2.2/80c71b2a4a7912fe/Name/1/0/
   ...
   --  insertion_sort.ads:8:3:Name
--  end read only

    Name : constant String := "Insertion Sort";
...
--  begin read only
--  end read only
end Insertion_Sort.Object_Test_Data.Object_Tests;
