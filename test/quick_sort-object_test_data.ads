...
package Quick_Sort.Object_Test_Data is

   type Object_Access is access all GNATtest_Generated.GNATtest_Standard.Quick_Sort.Object'Class;
...
end Quick_Sort.Object_Test_Data;
