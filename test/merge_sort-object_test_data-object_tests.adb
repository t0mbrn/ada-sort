...
--  placed into Merge_Sort.Object_Test_Data.
...
--  begin read only
--  end read only
package body Merge_Sort.Object_Test_Data.Object_Tests is
...
--  end read only
    ...
    Name : constant String := "Merge Sort";
