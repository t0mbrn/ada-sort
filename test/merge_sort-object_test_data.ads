...
package Merge_Sort.Object_Test_Data is

   type Object_Access is access all GNATtest_Generated.GNATtest_Standard.Merge_Sort.Object'Class;
...
end Merge_Sort.Object_Test_Data;
