...
package Heap_Sort.Object_Test_Data is

   type Object_Access is access all GNATtest_Generated.GNATtest_Standard.Heap_Sort.Object'Class;
...
end Heap_Sort.Object_Test_Data;
