...
--  placed into Selection_Sort.Object_Test_Data.
...
--  begin read only
--  end read only
package body Selection_Sort.Object_Test_Data.Object_Tests is
...
--  begin read only
--  end read only
end Selection_Sort.Object_Test_Data.Object_Tests;
